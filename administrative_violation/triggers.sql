...
VALUES (1001, -1, '2023-12-07', 'not payed');
...
DELETE FROM driver WHERE drivers_licence = 'IX-702005-22-87-45-JN';
...
CREATE TRIGGER violation_before_insert
...
VALUES (1001, 'Speeding', '2023-12-07, 11:15:25', NULL, 1, 'IX-702005-22-87-45-JN');
...
INSERT INTO fine(fine_id, fine_amount, payment_term, status)
VALUES (1001, 100, '2023-12-18', NULL);
